...
# nils.gg/database-operator-bundle:$VERSION and nils.gg/database-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= nils.gg/database-operator
...
## marker
	cat target/kubernetes/mongodbusers.nils.gg-v1alpha1.yml target/kubernetes/kubernetes.yml | operator-sdk generate bundle -q --overwrite --version $(VERSION) $(BUNDLE_METADATA_OPTS)
